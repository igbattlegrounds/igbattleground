...
<head>
    ...
    <link rel="icon" href="#">
    <title>IG Battlegrounds Adda </title>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">IG Battlegrounds <span class="sr-only"></span></a> </li>
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Choose map</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>select price</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">3. </span>start earning</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular Matches of the Month</h2>
                    <p class="lead">Easiest way to earning from Gaming select these top 6 Map/Mode</p>
                </div>
                <div class="row">
						<?php 					
            ...
            <div class="container">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose a Map</h3>
                                    <p>example, Erangel, livik, library, inventory etc.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">START Earning</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>IG WEB Developement. Radhna inayatpur. Meerut, Uttar pardesh, India </p>
                                    <h5>Phone: +91 9520130132</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>batter chance to become a National Esport Player</p>
                                </div>
                    </div>
                </div>
